...
console.log('  by kind (fade vs consensus/follow-the-money, since 2026-09-11)\n' + cut(counted, p => p.kind === 'consensus' ? 'consensus (follow the money)' : 'fade'));
