...
//   (Carl confirmed 2026-09-02: "I want both").
// Windows: football (NFL/CFB) game within 7 days; all other sports within 96 hours
//   (Carl 2026-09-02: 72h -> 96h, "alert me as soon as humanly possible", then re-confirm every run).
...
export const THRESHOLDS = Object.freeze({
  ...
  footballWindowDays: 7, otherWindowHours: 96,
});
...
export function evalMarket(sport, sides) {
  ...
  return {
    ...
    publicSide: pub.name, publicLine: pub.line ?? null, T, H, D, tier, downgraded,
  };
}
