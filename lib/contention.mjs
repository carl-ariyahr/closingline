...
// Every league with a standings + playoff-odds feed. (CFB/CBB have no standings-based
// playoff race — ranking/bracket driven — so contention can't be computed for them.)
const STANDINGS = {
