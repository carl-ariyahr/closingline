...
const TOKEN_ALIASES = {
  ...
  utsa: ['utsa'], utep: ['utep'], utrgv: ['ut', 'rio', 'grande', 'valley'], usf: ['south', 'florida'], ecu: ['east', 'carolina'], wku: ['western', 'kentucky'], niu: ['northern', 'illinois'], ulm: ['louisiana', 'monroe'], uconn: ['uconn', 'connecticut'], unlv: ['unlv'], uab: ['uab'], fsu: ['florida', 'state'], osu: ['ohio', 'state'],
