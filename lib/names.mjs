...
const TOKEN_ALIASES = {
  ...
  ark: ['arkansas'], fl: ['florida'], la: ['louisiana'], tenn: ['tennessee'], miss: ['mississippi'], conn: ['connecticut', 'uconn'],
  ...
  utsa: ['utsa'], texassanantonio: ['utsa'], texaselpaso: ['utep'], utrgv: ['utrgv'], texasriograndevalley: ['utrgv'],
